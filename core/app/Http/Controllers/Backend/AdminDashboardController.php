...
class AdminDashboardController extends Controller
{
    ...
    public function adminDashboard()
    {
        ...
        $dashboardData = [
            ...
            ['title' => __('Total Genders'), 'route' => 'admin.category', 'value' => Category::count()],
            ['title' => __('Total Ethnicities'),  'route' => 'admin.subcategory','value' => SubCategory::count()],
            ['title' => __('Total Ages'), 'route' => 'admin.child.category', 'value' => ChildCategory::count()],
