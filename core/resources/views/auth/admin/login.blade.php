...
<section class="loginForm">
    <div class="loginForm__flex">
            ...
            <div class="loginForm__left__inner desktop-center">
                <div class="loginForm__header">
                    ...
                    <p class="loginForm__header__para mt-3">
                        {{ __('Login with your data that you entered during registration.') }}
                    </p>
                </div>
                    ...
                    <form action="{{ route('admin.login') }}" class="custom_form" method="POST">
                        ...
                        <div class="single_input">
                            ...
                            <div class="include_icon">
                                ...
                                <div class="icon"><span class="material-symbols-outlined">{{ __('person') }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="btn_wrapper single_input">
                            <button type="submit" id="form_submit"
                                class="cmnBtn btn_5 btn_bg_blue radius-5 radius-5">{{ __('Sign In') }}</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="loginForm__right loginForm__bg"
            style="background-image: url('{{ asset('assets/backend/img/login.jpg') }}');">
