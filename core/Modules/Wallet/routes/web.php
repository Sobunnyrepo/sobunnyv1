...
// backend routes
Route::group(['prefix' => 'admin/wallet', 'as' => 'admin.wallet.','middleware' => ['auth:admin','setlang', 'globalVariable']], function () {
...
//user routes
Route::group(['as' => 'user.', 'prefix' => 'user', 'middleware' => ['auth', 'setlang', 'globalVariable']], function () {
    Route::controller(\Modules\Wallet\app\Http\Controllers\Frontend\UserWalletController::class)->group(function () {
